...
function Page() {
  return (
    <section className='pt-6 pl-60  bg-[#FFFFFF] flex'>
...
<div className='flex flex-col  pl-9'>
 ...
 <div className='sm:flex '>
  ...
  <div className='flex justify-between space-x-3'>
       ...
       <img 
        className=' h-72 pr-4 w-48  pt-9' 
         src='https://m.media-amazon.com/images/I/61Rvx5C7MBL._AC_UL320_.jpg'
          alt='' />
           </div>
  ...
  <div className='ml-16 sm:ml-0'>
       ...
       <img 
        className='h-72 w-52 pt-8  pl-11'
          src='https://m.media-amazon.com/images/I/81N--FHhbIL._AC_UL320_.jpg'
          alt='' />
           </div>
  ...
  <span className='text-[#007185]'>3,848</span>
    ...
    <div  className='space-x-3'>
       ...
       <img 
        className='h-[250px] w-44 pl-4' 
         src='https://m.media-amazon.com/images/I/71-7FsRsOcL._AC_UL320_.jpg'
          alt='' />
           </div>
  ...
  <span className='text-[#007185]'>47</span>
    ...
    <div>
        <div className=''>
       <div className='bg-gray-100    w-[280px] sm:w-60'>
       <h1 className='bg-[#E67A00] w-24 px-2 py-1  text-[#FFFFFF] zain text-sm'>Best Seller</h1>
       <img 
        className='h-64 w-48 pl-12'  
        src='https://m.media-amazon.com/images/I/91PcOvivUsS._AC_UL320_.jpg'
          alt='' />
           </div>
