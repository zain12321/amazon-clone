...
function Movies() {
 ...
 <div className=''>
<h1 className='font-bold text-[13px] sm:text-[17px] text-[#0F1111]'>Book Award Winners</h1>
<p className='flex sm:items-center text-[14px] pt-4  sm:text-sm  sm:pt-1'>
<RiCheckboxBlankLine className='h-[22px] text-gray-500 w-[22px]'/>Booker Prize</p>

 </div>
<div className='pt-3'>
<h1 className='text-md font-bold '>Amazon Global Store</h1>
    <p className='flex items-center'><RiCheckboxBlankLine className='h-[22px] text-gray-500 w-[22px]'/>Amazon Global Store</p>
</div>
<div className=''>
...
<div className='flex flex-col'>
  ...
  <h1 className='font-bold'>Availiblity</h1>
     <p className='flex items-center'><RiCheckboxBlankLine className='h-[22px] text-gray-500 w-[22px]' />Include Out of Stock</p>
</div>
...
<div className='flex flex-col pl-9'>
 ...
 <div className='sm:flex'>
  ...
  <div className='flex justify-between'>
       ...
       <h1 className='bg-[#555555] w-24 px-2 py-1  text-[#FFFFFF] zain text-sm'>Best Seller</h1>
       <img 
        className=' h-72  w-48 pl-8 ' 
         src='https://m.media-amazon.com/images/I/91KA1B7xWsL._AC_UL320_.jpg'
          alt='' />
           </div>
  ...
  <div className='ml-16 sm:ml-0'>
       ...
       <img 
        className='h-80 w-60 pt-8  pl-4'
          src='https://m.media-amazon.com/images/I/71JUcGupsDL._AC_UL320_.jpg'
          alt='' />
           </div>
  ...
  <span className='text-[#007185]'>3,848</span>
    ...
    <div>
        <div className=''>
       <div className='bg-gray-100 pt-9  w-64'>
       <img 
        className='h-[280px] w-50  px-4' 
         src='https://m.media-amazon.com/images/I/91pwTzHyeEL._AC_UL320_.jpg'
          alt='' />
           </div>
          <h1 className='text-[17px] hover:text-red-900'>
              Home Page
          <br/> <span className='text-md text-gray-700'>1998</span></h1>
  ...
  <span className='text-[#007185]'>47</span>
    ...
    <div>
        <div className=''>
       <div className='bg-gray-100 pl-6 pt-8  w-[280px]  sm:w-60'>
       <img 
        className='h-[280px] w-48 '  
        src='https://m.media-amazon.com/images/I/91Gt6NZHmVL._AC_UL320_.jpg'
          alt='' />
           </div>
